...
| Who | Contact | For | Status |
|---|---|---|---|
| **Show-Me State Games** — Jessie Sida (Dir. Strategic Partnerships & Special Events) | **573-884-2946** · main line ✅ **573-882-2101** · smsg.org · 1400 S Rock Quarry Rd, Entrance 5 | Food vendor slot, **Jul 17-19 / 24-26** (⏰ ~9 days out) | TO CALL |
| **Mizzou — vending AGREEMENT (FY27 renewal)** — Casey E. Forbis, Sr. Business Services Consultant (MU **Finance & Business Services**) | via Finance/Business Services · COI → risk@umsystem.edu | Renew the Food Cart *agreement* before fall (~$500) | TO CALL |
| **Mizzou — FOOD-SAFETY PERMIT / cart approval** — MU EHS Sanitarian ✅ | ✅ **573-882-7018** · ehs@missouri.edu · **muehssanitarian@missouri.edu** · 900 E Stadium Blvd, Ste 180 | Required for any recurring on-campus cart: Temporary Food Permit + MU Approved Vendor List | TO CALL |
| **Catering funnel** — inbound | booking form → Supabase `catering_leads` · your line 314-266-8636 · glizzness@gmail.com | Deploy + market the catering page | IN PROGRESS |

> ⚠️ **Correction from research:** last year's paperwork tied Mizzou to "Casey Forbis / EHS," but those are **two separate offices** — Forbis handles the *business agreement* (Finance & Business Services), while the *food-safety permit* goes through the **EHS Sanitarian** above. You likely need both.
...
| **Veterans United** ⭐ (~2,800, #1) **— REPEAT CLIENT** | ✅ **573-876-2600** (toll-free 800-884-5560) · 1400 Forum Blvd Ste 18, 65203 · general customer_service@veteransunited.com · press communications@vu.com · HR careers@vu.com | ✅ **Reconnect, don't cold-pitch** — we've catered VU before (invoices on file). Reach back to the prior events contact; switchboard "reaches any dept" → employee-experience / HR / events | **RECONNECT — repeat client** |
...
|---|---|---|
| **Bur Oak Brewing** ⭐ | ✅ **explicitly allows food trucks inside or outside** (buroakbeer.com/rent-the-brewery — most receptive target) · events@buroakbeer.com | TO CALL |
| **Cooper's Landing** (hosts vendors most weekends) | ✅ **info@cooperslandingmo.com** · music@cooperslandingmo.com · 573-657-1299 · no named contact — ask for events/entertainment coordinator | TO CALL |
| **Rose Music Hall** (booking shared w/ Blue Note) | ✅ **573-874-1944** · **booking@thebluenote.com** · info@thebluenote.com · 1013 Park Ave 65201 | TO CALL |
| **The Blue Note** | ✅ **573-874-1944** · info@thebluenote.com · private events → fpcspecialevents.com/contact · 17 N. 9th St 65201 | TO CALL |
...
|---|---|---|
| **Hippos Cannabis** | ⚠️ **info@hipposcannabis.com** · 573-507-3660 · 2500 Broadway Bluffs Dr **Ste 102** 65201 · ask for the marketing/events lead | TO CALL |
| **Good Day Farm** | ⚠️ contact-page phone **573-355-9346** (differs from 573-298-6984) · 812 Vandiver Dr 65202 · ask for the marketing/events lead | TO CALL |

## 🥩 Suppliers / partners
| Who | For | Contact |
|---|---|---|
| **Patchwork Family Farms** | local pork (pulled pork, brats — already on menu) | ⚠️ **573-446-1568 · patchwork@morural.org** (program of the MO Rural Crisis Center) |
| Flyover | commissary / ghost-kitchen base | *on file* |

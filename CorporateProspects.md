# The Glizzness — Columbia Corporate Catering Prospects

*Internal B2B target list for the **Corporate & Workplace Accounts** lane (prepaid on-site **cart days** + boxed-lunch **drop-offs**). NOT public, NOT on the events map.*
*Built 2026-07-06 from an adversarially-verified research pass. Primary source: [REDI "Boone County Largest Employers" Q1-2024](https://columbiaredi.com/wp-content/uploads/2023/02/Boone-County-Largest-Employers-2025.pdf) + [City of Columbia](https://www.como.gov/about/). Headcounts are Boone County, ~2 yrs old — treat as size signal, not gospel.*

**How to work it:** pitch the **office manager / HR / "culture" or "people" team / facilities**. Offer (a) a standing **cart day** on their lot for a flat prepaid fee, or (b) **boxed-lunch drop-off** for a headcount. Lead with the easy win: a free/discounted first "taste day" to land the account, then recurring.

---

## Tier 1 — Best fit (big office workforces, likely NO in-house cafeteria) 🎯
These are the bullseyes: hundreds of on-site office staff, no cafeteria, culture-forward.
...
| **Watlow** | ~236 | 2101 Pennsylvania Dr, 65202 | Manufacturing + engineering; confirmed active. |
| **Central Bank of Boone County** | ~340 | Columbia | Banking offices. |
| **Midway USA** | ~300 | Columbia | Retailer HQ/warehouse. |
| **MBS Textbook Exchange** | ~470 | Columbia | Textbook distribution. |
| **Eurofins BioPharma** | ~336 | Columbia | Lab/testing staff. |
| **Emery Sapp & Sons** | ~501 | Columbia | Construction HQ (crews + office). |

## Tier 2 — Event / appreciation catering (huge staff, but likely have cafeterias) 🎪
Weak for *daily* feeds, but great for **staff-appreciation days, department events, and vendor/customer events**.

| Org | ~Staff | Location | Notes |
|---|---|---|---|
| **University of Missouri** | ~10,000 (largest overall) | Campus | Go **department by department** (already have the cart vending permit — see MU agreement). |
| **MU Health Care** | ~8,100 | University Hospital, 24/7 | Dept events / staff appreciation. |
| **Columbia Public Schools** | ~3,000 | 33 schools | Teacher-appreciation, staff PD days, bulk orders. |
| **Truman VA Hospital** | ~2,074 | 800 Hospital Dr, 65201 | Large 24/7 institution; event catering. |
| **Boone Health** | ~1,400 | Columbia hospital | Dept/appreciation events. |
| **City of Columbia** | ~1,442 | Multiple sites | Employee events. |
| **Boone County Government** | ~500 | Annex, 613 E. Ash Rm 102, 65201 | **Verified contact:** HR Director **Angela Wehmeyer · hr@boonemo.gov · 573-886-4395**. |
| **Kraft Heinz / Oscar Mayer** | ~450 | 4600 Waco Rd, 65202 | 24/7 hot-dog plant (ironic + fun angle!); likely cafeteria → event fit. |
| **Quaker Oats** | ~360 | 4501 Paris Rd | 24/7 plant. |
| **JBS / Swift / Principe** | ~200–400 | Columbia charcuterie plant | Growing. |
| **Dana Light Axle** | ~380 | 2400 Lemone Industrial Blvd | Auto-parts plant. |
| **Joe Machens Dealerships** | ~600 (2022) | Multiple Columbia lots | Sales staff + customer events. |

## Cannabis 🌿
Recreational + medical; good for **staff feeds** and **customer-appreciation / vendor days** (they host events).
- **Hippos Cannabis** — 2500 Broadway Bluffs Dr Ste 102, 65201 · 573-507-3660
- **Good Day Farm** — 812 Vandiver Dr, 65202 · 573-298-6984

...
**Emerging lane:** **Worksite / crew feeding** — roll up to captive work crews with no food nearby, prepaid per crew. Standout: **Improve I-70** through Boone County — confirmed **night work**, ~350 workers at peak. Start with **Emery Sapp & Sons** (local contractor on the $441M Rocheport→Columbia segment, 2026–2029) — who are *also* a ~500-person Columbia employer, so it's a **double account**. Recent new arrivals to work (Paris Rd corridor): **EquipmentShare** campus, **Schneider Electric** + **Swift/Principe** plants; verify leads **Aurora Organic Dairy** (the dairy — real), Amazon (Ashland), American Outdoor Brands DC. (No Beyond Meat plant.) Full detail + contacts: `CorporateProspects.md`.
